...
//     return(
//         // for the space of the top the screen
//         <div className="mt-5">
//             <div className="text-center my-16">
               
//                 <h1 className="text-4xl font-semibold">How to Install Our App</h1>
//                 <p className="text-2xl mb-10 text-gray-700">Getting started is quick and easy! Follow these simple steps to install and start using MyBindle today.</p>
//             </div>
